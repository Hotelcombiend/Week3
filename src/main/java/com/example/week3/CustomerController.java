...
public class CustomerController {
    ...
    public boolean addCustomer(@RequestParam("id") String ID, @RequestParam("name") String name,
        ...
        this.customers.add(new Customer(ID, name, sex_1, age));
        return true;
    }
    @RequestMapping(value = "/addCustomer2", method = RequestMethod.POST)
    public boolean addCustomer2(@RequestParam("id") String ID, @RequestParam("name") String name,
                                @RequestParam("age") int age, @RequestParam("sex") String sex){
        boolean sex_2 = false;
        if(sex.equals("male")){
            sex_2 = true;
        ...
        this.customers.add(new Customer(ID, name, sex_2, age));
        return true;
    }
}
